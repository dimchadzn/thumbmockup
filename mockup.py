...
# ========== STREAMLIT UI ==========
st.set_page_config(page_title="Pixel Perfect Mockup", layout="centered")
st.title("🎯 Pixel Perfect Thumbnail Mockup Generator")
...
if thumb_file and title and channel_name:
    ...
    font_channel = ImageFont.truetype("/System/Library/Fonts/Supplemental/Arial.ttf", 56)
    font_subs = ImageFont.truetype("/System/Library/Fonts/Supplemental/Arial.ttf", 45)
    font_dur = ImageFont.truetype("/System/Library/Fonts/Supplemental/Arial Bold.ttf", 38)
    ...
    mockup.save("mockup_final_output.jpg")
    with open("mockup_final_output.jpg", "rb") as f:
        st.download_button("Download Mockup", f, file_name="twitter_mockup.jpg")
